...
class DAO
{
	...
	public static function add($obj)
	{
		...
		/* création de la requete insert */ 
		$requ = "INSERT INTO " . $class . "(";
		/* preparation de la variable values */ 
		$values = "";
	...
	public static function update($obj)
	{
		...
		$class = get_class($obj);
		$colonnes = $class::getAttributes();
		$requ = "UPDATE " . strtolower($class) . " SET ";
	...
	{ /* connexion a la bdd */ 
		...
		/* selection des attributs */ 
		$colonnes = $class::getAttributes();
		/* selection de la methode get */ 
		$methode = "get" . ucfirst($colonnes[0]);
		/* retourne la requete */ 
		return $db->query("DELETE FROM " . $class .
		 " WHERE " . $colonnes[0] . " = " . $obj->$methode());
	}
