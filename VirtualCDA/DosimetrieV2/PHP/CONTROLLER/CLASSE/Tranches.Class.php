...
class Tranches 
{
	...
	private $_IdChantier;
	private static $_attributes=["IdTranche","LibelleTranche","DescriptionTranche","PhotoTranche","IdChantier"];
	/***************** Accesseurs ***************** */
	...
	*/
	...
	{
		return "IdTranche : ".$this->getIdTranche()."LibelleTranche : ".$this->getLibelleTranche()."DescriptionTranche : ".$this->getDescriptionTranche()."PhotoTranche : ".$this->getPhotoTranche()."IdChantier : ".$this->getIdChantier()."\n";
	}
}