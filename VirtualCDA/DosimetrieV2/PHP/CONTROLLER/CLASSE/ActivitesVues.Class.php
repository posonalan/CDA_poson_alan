...
class ActivitesVues 
{
	...
	private $_IdBatiment;
	private $_DosimetrieActivite;
	private static $_attributes=["IdActivite","LibelleActivite","DescriptionActivite","Risque","Parade","PhotoActivite","EffectifActivite","TempsActivite","IdOperation","IdBatiment","DosimetrieActivite"];
	/***************** Accesseurs ***************** */
	...
	public function getDosimetrieActivite()
	{
		return $this->_DosimetrieActivite;
	}

	public function setDosimetrieActivite(?float $DosimetrieActivite)
	{
		$this->_DosimetrieActivite=$DosimetrieActivite;
	}
	...
	*/
	...
	{
		return "IdActivite : ".$this->getIdActivite()."LibelleActivite : ".$this->getLibelleActivite()."DescriptionActivite : ".$this->getDescriptionActivite()."Risque : ".$this->getRisque()."Parade : ".$this->getParade()."PhotoActivite : ".$this->getPhotoActivite()."EffectifActivite : ".$this->getEffectifActivite()."TempsActivite : ".$this->getTempsActivite()."IdOperation : ".$this->getIdOperation()."IdBatiment : ".$this->getIdBatiment()."DosimetrieActivite : ".$this->getDosimetrieActivite()."\n";
	}
}