...
CREATE VIEW consoles_utilisateurs as
SELECT utilisateurs.`idutilisateur`,`nom`,`prenom`,consoles.`idConsole`,`libelleConsole`,`idMarque`
FROM `profiles`
INNER JOIN consoles
ON profiles.idConsole = consoles.idConsole
INNER JOIN utilisateurs
ON profiles.idUtilisateur = utilisateurs.idUtilisateur
