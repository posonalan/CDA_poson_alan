...
class Accessoires 
{
	...
	private $_idMarque;
	private static $_attributes=["idAccessoire","libelleAccessoire","idMarque"];
	/***************** Accesseurs ***************** */
	...
	*/
	...
	{
		return "IdAccessoire : ".$this->getIdAccessoire()."LibelleAccessoire : ".$this->getLibelleAccessoire()."IdMarque : ".$this->getIdMarque()."\n";
	}
}