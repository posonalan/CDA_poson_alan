...
$routes=[
 ...
 "APIUtilisateurs"=>["PHP/MODEL/API/","APIUtilisateurs", "APIAuteurs",false,[0],true],
    "APIProfiles"=>["PHP/MODEL/API/","APIProfiles", "APICreations",false,[0],true],
    "APIJeux"=>["PHP/MODEL/API/","APIOeuvres", "APIJeux",false,[0],true],
    "APIUtilisateursJeux"=>["PHP/MODEL/API/","APIUtilisateursJeux", "APIAuteursOeuvres",false,[0],true],
