...
echo '<div class="caseForm col-span-form">Formulaire Accessoires</div>';
if ($mode != "Ajouter") {
	echo '<div class="noDisplay"><input type="hidden" value="'.$elm->getIdAccessoire().'" name=IdAccessoire></div>';
};
echo '<div class="caseForm">LibelleAccessoire</div>';
echo '<div class="caseForm"><input type="text" '.$disabled;
echo ($mode == "Ajouter") ? "" : " value=".$elm->getLibelleAccessoire(); echo ' name=LibelleAccessoire pattern="'.$regex["*"].'"></div>';
