...
echo '<div class="caseListe grid-columns-span-4">Liste des Marques </div>';
...
echo '<div class="caseListe">LibelleMarque</div>';
...
{
echo '<div class="caseListe">'.$unObjet->getLibelleMarque().'</div>';
