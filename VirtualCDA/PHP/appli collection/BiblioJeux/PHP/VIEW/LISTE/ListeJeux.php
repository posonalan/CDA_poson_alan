...
echo '<div class="caseListe grid-columns-span-5">Liste des Jeux </div>';
...
echo '<div class="caseListe">LibelleJeu</div>';
...
{
echo '<div class="caseListe">'.$unObjet->getLibelleJeu().'</div>';
