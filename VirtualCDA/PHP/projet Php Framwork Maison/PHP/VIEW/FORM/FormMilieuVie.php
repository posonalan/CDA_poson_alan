...
if (isset($_GET['id'])) {
    ...
    $milieu = MilieuVieManager::findById($_GET['id']);
}
else{
    /* sinon on crée un nouvel objet */ 
    $milieu = new MilieuVie();
}
...
echo '  <label> Type de milieu de vie  :</label>
        <input type="text" name="TypeMilieuVie" value="' . $milieu->getTypeMilieuVie() . '"' .$disabled.'>';
