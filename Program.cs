...
namespace Exercise_3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ////Console.WriteLine(" Vous souhaitez savoir la date que nous seront dans plusieurs jours ? "); 
            //Console.WriteLine(" Vous souhaitez savoir la date de demain ? ");
            //Console.WriteLine(" Saisissez le jour : ");
            //Jr = Console.ReadLine();
            //jour = Int32.Parse(Jr);
            //Console.WriteLine(" Saisissez le mois : ");
            //Ms = Console.ReadLine();
            //mois = Int32.Parse(Ms);
            //Console.WriteLine(" Saisissez l annee : ");
            //An = Console.ReadLine();
            //annee = Int32.Parse(An);
            ////Console.Write("\n Vous souhaitez savoir dans combien de jours ? ");
            ////da = Console.ReadLine();
            ////dat = Int32.Parse(da);


            ////days = DateTime.DaysInMonth(annee, mois);
            ///* fonction qui me permet de savoir combien il y a de jours dans le mois*/
            ...
            ///* fonction qui verrifie si l'année est bissextile */
...
>>>>>>> 4cca296208a2edb1c9d3a7ddc2ed5fae45f557ee
                }
                return resultat;
            }
